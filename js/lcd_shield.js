...
(function(ext) {
	...
	var _level = 0;
	ext.motor_output = function(output,sens, high_low, speed){
		_level = 1 - _level;
        runPackage(30,output, high_low,sens, speed,_level);
	}
	/*******************************
	********************************
	*******************************/
    ...
    function deviceOpened(dev) {
        ...
        device.set_receive_handler('motor',function(data) {
            processData(data);
        });
    };
    ...
    ext._getStatus = function() {
        ...
        if(watchdog) return {status: 1, msg: 'Probing for motor'};
